    ...
    <div className="bg-slate-400 xl:place-content-center py-20 px-20 grid gap-10 lg:grid-cols-2 xl:grid-cols-3 min-h-screen">
      <div className="bg-white flex flex-col justify-between p-6 rounded-3xl shadow-xl">
        ...
        <div className="flex justify-between mt-2">
          <span className="text-gray-500 mb-2">Grey Chair</span>
        ...
        <button className="mt-5 bg-blue-500 text-white p-3 text-center rounded-xl w-full hover:bg-teal-500 hover:text-black active:bg-yellow-500 focus:bg-red-500 block mx-auto">Checkout</button>
      </div>
      <div className="bg-white overflow-hidden rounded-3xl shadow-xl group">
        ...
        <div className="rounded-3xl p-6 bg-white relative -top-5">
          <div className="flex relative -top-16 items-end justify-between">
            ...
            <div className="h-24 w-24 bg-blue-200 rounded-full group-hover:bg-red-300 transition-colors">
            </div>
            <div className="flex flex-col items-center">
          ...
          <div className="relative flex flex-col items-center -mt-10 -mb-5">
              ...
              <span className="text-sm text-gray-500">New Yotk, USA</span>
            </div>
        </div>
      </div>
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-3 mb-5 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-5">
              <button className="p-1 rounded-lg bg-blue-200 flex justify-center items-center aspect-square w-8 font-semibold text-xl text-gray-500">-</button>
              <span>1</span>
              <button className="p-1 rounded-lg bg-blue-200 flex justify-center items-center aspect-square w-8 font-semibold text-xl text-gray-500">+</button>
            </div>
          </div>
          <div className="flex justify-between items-center">
            ...
            <button className="bg-blue-500 px-8 py-2 text-center text-white rounded-lg text-xs">Add to Cart</button>
          </div>
        </div>
